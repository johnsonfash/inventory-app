...
export const routes: RouteObject[] = [
  ...
  { path: "/reporting/reorder", Component: page(() => import("./pages/reporting/reorder")) },
  ...
  { path: "/sales/gift-cards", Component: page(() => import("./pages/sales/gift-cards")) },
  { path: "/customers/tickets", Component: page(() => import("./pages/customers/tickets")) },
  { path: "/customers/tickets/new", Component: page(() => import("./pages/customers/tickets/new")) },
  { path: "/customers/tickets/:id", Component: page(() => import("./pages/customers/tickets/[id]")) },
  ...
  { path: "/settings/loyalty", Component: page(() => import("./pages/settings/loyalty")) },
